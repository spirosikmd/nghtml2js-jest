...
4. Run `cd example && yarn test` to make sure tests pass for the example
...
Please checkout [the issues](https://github.com/spirosikmd/ng2html-jest/issues)! Also, please watch the repo
